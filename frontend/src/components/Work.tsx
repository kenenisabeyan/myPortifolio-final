...
const Work = () => {
  ...
  return (
    ...
    />
    <section id="skills" className="py-16 md:py-24 px-4 md:px-10 lg:px-16 relative z-10 bg-white dark:bg-transparent">
          ...
          {categoriesInfo.map((cat, idx) => (
            ...
            >
              ...
              <div className="relative z-10 flex flex-col gap-4">
                {categorizedTech[cat.id as keyof typeof categorizedTech]?.map((item, i) => (
    ...
    <section id="work" className="py-16 md:py-24 px-4 md:px-10 lg:px-16 relative z-10 bg-white dark:bg-transparent">
      <div className="max-w-[1700px] mx-auto flex flex-col relative z-10">
