    ...
    <section id="achievements" className="py-24 md:py-32 px-4 md:px-10 lg:px-16 relative z-10 bg-transparent dark:border-t dark:border-white/[0.05]">
      <div className="max-w-[1700px] mx-auto flex flex-col relative z-10">
        ...
        <div className="max-w-[1200px] mx-auto w-full">
          <div className="bg-[#07101f]/90 dark:bg-[#020817]/95 border border-white/[0.08] border-l-cyan-500 border-t-cyan-500 border-l-[8px] border-t-[8px] rounded-[2.5rem] p-10 md:p-14 backdrop-blur-xl shadow-[0_20px_80px_rgba(0,0,0,0.24)] hover:shadow-[0_25px_90px_rgba(34,211,238,0.2)] transition-all duration-300">
              ...
              <div className="flex items-center gap-6">
                ...
                <div>
                  <h3 className="text-2xl md:text-3xl font-bold text-white leading-snug">
                    Entrepreneurship &amp; Startup Innovation Fellow
                  </h3>
            ...
            <p className="text-base md:text-lg font-normal text-gray-300 leading-relaxed border-t border-white/10 pt-8 mb-10">
              Successfully completed the Early-Stage Startup Training Program in partnership with MinT, KOICA, and OSTA. Developed the EDOT Platform with a focus on transforming local creative ideas into scalable, product-ready services. Recognized for excellence in a competitive cohort of innovators aimed at driving national economic development and reducing technological reliance through local innovation.
            </p>
